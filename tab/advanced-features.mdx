...
You can also use Cursor Tab in the "Go to Definition" or "Go to Type Definition" peek views. This is useful for 
for example adding a new argument to a function call.
