...
Pick your preferred AI model through the [model toggle](/advanced/model-toggle), and Cursor Chat will use that model to generate responses. You can toggle between models by pressing `Ctrl/⌘ /`. 
